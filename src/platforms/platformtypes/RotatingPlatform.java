...
public class RotatingPlatform extends DecoratedPlatform {
	 ...
	 * @param decoratorComponent AbstractPlatform representing the platform this class is decorating
	 */
	...
	/**
	 * Function to implement the behavior of this object and which is called in the update
	 * function defined in its super class. In this case, rotating around the platform's left axis
	 * @param speed double that is unused in this class' implementation of this function
	 * @param distance double that is unused in this class' implementation of this function
	 */
	@Override
	...
	/**
	 * Rotates the platform clockwise around the center axis at a speed determined by the delay parameter
	 * @param delay int that determines the rotational speed. The higher the delay the slower the platform will rotate
	 */
	...
	/**
	 * Rotates the platform clockwise around the left axis at a speed determined by the delay parameter
	 * @param delay int that determines the rotational speed. The higher the delay the slower the platform will rotate
	 */
	 ...
	 * as well as the platforms that it may decorate.
	 */
	@Override
