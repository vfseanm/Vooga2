...
public class GodClass
{
    ...
    public synchronized static Object Do (Object ... o)
    {
        ...
        try
        {
            fstream = new FileWriter("./src/platforms/PlatformResourceBundlez.properties");
            Scanner in = new Scanner(new File("./src/platforms/PlatformResourceBundle.properties"));
        ...
        try
        {
            fstream = new FileWriter("./src/platforms/PlatformResourceBundle.properties");
            Scanner in = new Scanner(new File("./src/platforms/PlatformResourceBundlez.properties"));
            BufferedWriter out = new BufferedWriter(fstream);
            while(in.hasNextLine()){
               out.write( in.nextLine());
               out.write("\n");
        ...
        /* Through the power of voodo magic, creates a string of some arbitrary class, creates this class and then breaks.
           Should this be unsuccessful, we try again.
           Some statistical law states this this will work...eventually
        */
        while (true)
        {
        ...
        Random generator = new Random();
        if(generator.nextInt(Integer.MAX_VALUE) != generator.nextInt(Integer.MAX_VALUE) )
            GodClass.Do(toReturn);
